    ...
    ru: {
      grunge: {
        ...
        cases: [
          ...
          ['ВЕБ · Э-КОММЕРС', 'Э-КОММЕРС / КАТАЛОГ', 'Интернет-магазин с выразительной визуальной системой, каталогом, карточками товаров и понятным пользовательским путём от выбора до покупки.'],
          ['ВЕБ · Э-КОММЕРС', 'Э-КОММЕРС / КАТАЛОГ', 'Каталог или интернет-магазин с товарами, категориями и понятным пользовательским путём от выбора до заказа.'],
          ['UI/UX · ВЕБ-ПРИЛОЖЕНИЕ', 'ВЕБ-ПРИЛОЖЕНИЕ UI/UX', 'Сложные веб-интерфейсы, личные кабинеты и панели управления: логика, сценарии пользователя и визуальная система.'],
          ['ВЕБ · РЕДИЗАЙН', 'РЕДИЗАЙН САЙТА', 'Формат «было / стало»: анализ проблем существующего сайта, новая структура и более выразительное визуальное решение.'],
          ['UI · СИСТЕМА', 'ДИЗАЙН-СИСТЕМА / UI KIT', 'Компоненты, типографика, цвета и состояния интерфейса, собранные в единую систему для цифрового продукта.'],
          ['ВЕБ · РЕДИЗАЙН', 'РЕДАКЦИОННЫЙ САЙТ', 'Концептуальный многостраничный сайт с акцентом на типографику и визуальную подачу.']
        ],
      ...
      classic: {
        ...
        studies: 'Избранные кейсы', meta: '07 ПРОЕКТОВ · ЛИСТАЙТЕ НИЖЕ',
        cases: [
          ['ВЕБ · ЛЕНДИНГ', 'ВЕРОНА ХАУС', 'Лендинг бутикового отеля с классической эстетикой, редакционной типографикой и акцентом на атмосферу пространства.'],
          ['ВЕБ · Э-КОММЕРС', 'Э-КОММЕРС / КАТАЛОГ', 'Интернет-магазин в классической эстетике: каталог, карточки товаров и понятный пользовательский путь от выбора до покупки.'],
          ['ВЕБ · Э-КОММЕРС', 'Э-КОММЕРС / КАТАЛОГ', 'Каталог или интернет-магазин с понятной системой категорий, карточками товаров и удобным пользовательским сценарием.'],
          ['UI/UX · ВЕБ-ПРИЛОЖЕНИЕ', 'ВЕБ-ПРИЛОЖЕНИЕ UI/UX', 'Интерфейсы веб-сервисов, личных кабинетов и dashboard-систем. Работа со сценариями, информационной архитектурой и состояниями интерфейса.'],
          ['ВЕБ · РЕДИЗАЙН', 'РЕДИЗАЙН САЙТА', 'Формат «было / стало»: анализ существующего сайта, устранение проблем структуры и визуала, создание более понятного решения.'],
          ['UI · СИСТЕМА', 'ДИЗАЙН-СИСТЕМА / UI KIT', 'Система компонентов, типографики, цветов и состояний, которая помогает сохранять единый стиль цифрового продукта.'],
          ['ВЕБ · РЕДИЗАЙН', 'РЕДАКЦИОННЫЙ САЙТ', 'Концептуальный сайт с акцентом на классическую типографику, композицию и визуальную подачу.']
        ],
